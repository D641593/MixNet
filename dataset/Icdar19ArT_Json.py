...
class ArtTextJson(TextDataset):
    def __init__(self, data_root, is_training=True, ignore_list=None, load_memory=False, transform=None):
        ...
        # self.image_root = os.path.join(data_root, "train_images" if is_training else "test_part1_images")
        ...
        if self.is_training:
            annotation_file = os.path.join(data_root, "train_labels.json" if is_training else "None")
