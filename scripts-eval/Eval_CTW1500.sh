...
do 
CUDA_VISIBLE_DEVICES=4 python3 eval_mixNet.py --net mixTriHRnet_hor --scale 1 --exp_name Ctw1500 --checkepoch $i --test_size 640 1024 --dis_threshold 0.3 --cls_threshold 0.85
